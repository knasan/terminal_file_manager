...
tfm (Terminal File Manager) is a terminal tool developed in C++ and FXTUI (https://github.com/ArthurSonzogni/FTXUI), specializing in cleaning up and efficiently managing large, cluttered file directories.
